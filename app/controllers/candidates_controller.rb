  ...
  private
    ...
    def candidate_params
      params.require(:candidate).permit(:photo,:first_name,:last_name,:address,:mobile,:email,:citizenship,:birth_date,
        ...
        :smoker, :car,:driving_licence,:availability_ids,education_info_attributes:[:level,:history,:languages],work_info_attributes:[:sectors_experience,:years_experience,
          :current_job,:last_employer,:key_skills,:salary])
    end
end
