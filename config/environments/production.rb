Rails.application.configure do
  ...
  config.action_mailer.asset_host = 'http://elitepersonalworld.com'
  ...
  config.action_controller.asset_host = 'https://elitepersonalworldapp.s3-website-eu-west-1.amazonaws.com'
